<html>
  <head>
    <title>Tasks, Работа с регистром символов</title>
		<link href="styletasks.css" rel="stylesheet">
  </head>
  <body>
...
<div>
    <ul>
        ...
        <i>Для решения задач данного блока вам понадобятся следующие функции: strtolower, strtoupper, ucfirst, lcfirst, ucwords.</i><br>
			<a href="http://php.net/manual/ru/function.strtolower.php">strtolower </a>— Преобразует строку в нижний регистр<br>
			<a href="http://php.net/manual/ru/function.strtoupper.php">strtoupper</a> — Преобразует строку в верхний регистр<br>
			<a href="http://php.net/manual/ru/function.ucfirst.php">ucfirst</a> — Преобразует первый символ строки в верхний регистр<br>
			<a href="http://php.net/manual/ru/function.lcfirst.php">lcfirst</a> — Преобразует первый символ строки в нижний регистр<br>
			<a href="http://php.net/manual/ru/function.ucwords.php">ucwords</a>— Преобразует в верхний регистр первый символ каждого слова в строке<br>
		<h3>Завдання 1.</h3><br>
        Дана строка <b>'php'</b>. Сделайте из нее строку <b>'PHP'</b>.
	       <div class="example"> Початковий вигляд (якщо він існує):<br><?php $f="php"; ?></div>
        ...
        <h3>Завдання 2.</h3><br> Дана строка <b>'PHP'</b>. Сделайте из нее строку <b>'php'</b>.<br>
            <div class="example"> Початковий вигляд (якщо він існує):<br><?php $c='PHP'; ?> </div>
        ...
        <h3>Завдання 3.</h3><br>Дана строка <b>'london'</b>. Зробіть з неї строку <b>'London'</b>.
            ...
            <div class="example"> Результат виконання:<br><?php echo $rez; ?></div>
            <div class="example">
                <h3>Код PHP</h3>
                <div class="rezult">
                      $b="london";<br>
        ...
        <h3>Завдання 5.</h3> Дана строка <b>'london is the capital of great britain'</b>. Сделайте из нее строку <b>'London Is The Capital Of Great Britain'.</b>. <br>
